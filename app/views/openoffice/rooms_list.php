...
<div class="openoffice-rooms-container">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($room['object_status'] === 'available'): ?>
                                    <a href="<?php echo BASE_URL . 'openoffice/createreservation/' . htmlspecialchars($room['object_id']); ?>" class="btn btn-sm btn-info me-1" title="Book this room">
                                        <i class="fas fa-calendar-plus"></i> Book
                                    </a>
                                <?php endif; ?>

                                <?php if (userHasCapability('MANAGE_ROOMS')): // Admin actions ?>
    ...
    <?php else: ?>
        <div class="alert alert-info">No rooms found. <?php if (userHasCapability('MANAGE_ROOMS')): ?>You can add one using the button above.<?php endif; ?></div>
    <?php endif; ?>
</div>
